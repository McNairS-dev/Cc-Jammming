...
####Hint
----
+ To create a React app, you can use Vite, the modern build tool recommended by the React team. Open up your terminal, navigate to the directory you want to store your project, and use the following commands:

```
npm create vite@latest Jammming -- --template react
```

+ Navigate to the Jammming project folder using cd and use the command npm run dev to start a development server and see a preview of your app as you work.
...
+ Set up a remote origin and push the initial files to a repository on GitHub. You should be consistently committing your changes throughout the project. Make sure to have meaningful commit messages.
...
+ If you want a refresher on the syntax, look back at the Git cheat sheet.
...
+ To make your request to the API, use the /v1/search?type=TRACKendpoint. You can refer to the for guidance on formatting your request.
####Hint
----
...
+ See 'Resources' for tips on debugging and a sample of the completed project.

# Jammming Part II
## Create a Playlist App With the Spotify API (Part Two)

#Is there already a function to display all of a user's playlists?
